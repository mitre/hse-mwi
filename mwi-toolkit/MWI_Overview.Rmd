...
The Mental Wellness Index (MWI) is a framework and tool that provides data on factors influencing community-level mental wellness for each ZIP code\* in the nation. Mental Wellness means everyone in a community can thrive, regardless of a mental health or a substance use challenge.[^1] The MWI is composed of 28 measures organized under 3 domains: *Social Determinants of Health*, *Healthcare Access*, and *Health Status*. Additionally, the framework includes two dynamic factors: *Structural Racism* and *Community & Cultural Assets*. These factors are woven around and throughout the MWI domains, reflecting their influence throughout the framework.
...
![MWI Framework and Explanation](supporting_images/mwi_framework_w_explanation.png)
