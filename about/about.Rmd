...
- **Equity**: Does the measure capture inequities between populations, value group differences, and build on best science and community experience without introducing bias? Is the measure in line with a “do no harm” approach?
- **Importance**: Is the measure an important factor contributing to mental wellness, reflective of a high preventable burden (economic, disability, mortality), and is it evidence-based? 
- **Relevance and Usability**: Is information produced by the measure meaningful, understandable, useful for decision-making? Does it convey a sense of the obligation to act? 
- **Scientific Soundness**: What is the measure’s sensitivity, specificity, reliability, and validity? 
- **Feasibility**: What is the collection burden for a measure? Are the data updated frequently and available on a timely basis? 
