...
|Below 100% Federal Poverty Level|<span style="color:#5d499e">SDOH</span> |Income & Unemployment|Black Population|ACS|
|Broadband Access|<span style="color:#5d499e">SDOH</span> |Built Environment|Black Population|ACS|
|Housing Stress|<span style="color:#5d499e">SDOH</span> |Housing|Black Population|HUD CHAS|
...
|Mortgage Acceptance Rate|<span style="color:#5d499e">SDOH</span> |Financial Access|Black Population|HMDA, Consumer Financial Protection Bureau|
|No High School Diploma|<span style="color:#5d499e">SDOH</span> |Education|Black Population|ACS|
|Nursery and Preschool Enrollment|<span style="color:#5d499e">SDOH</span> |Education|Black Population|ACS|
|Police Killings|<span style="color:#5d499e">SDOH</span> |Safety & Community Trauma|Black Population|Mapping Police Violence|
|Residential Segregation|<span style="color:#5d499e">SDOH</span> |Housing|Black Population|ACS|
|Third Places|<span style="color:#5d499e">SDOH</span> |Social Capital|Not applicable|CBP|
|Unemployment|<span style="color:#5d499e">SDOH</span> |Income & Unemployment|Black Population|ACS|
...
|Uninsured|<span style="color:#70ad47">Healthcare Access</span>|Health Insurance|Black Population|ACS|
|Adult Binge Drinking|<span style="color:#157ba7">Health Status</span>|Substance Use|Not available|CDC BRFSS, PLACES|
|Alcohol-Related Mortality|<span style="color:#157ba7">Health Status</span>|Substance Use|Black Population|CDC WONDER
|Estimated Drug Poisoning|<span style="color:#157ba7">Health Status</span>|Substance Use|Black Population|CDC WONDER|
|Insufficient Sleep|<span style="color:#157ba7">Health Status</span>|Other Morbidity & Mortality|Not available|CDC BRFSS, PLACES|
|Life Expectancy|<span style="color:#157ba7">Health Status</span>|Other Morbidity & Mortality|Black Population (extrapolated)|CDC USALEEP, NVSS|
...
|Suicide Mortality|<span style="color:#157ba7">Health Status</span>|Mental Health|Black Population|CDC WONDER|
_Notes_:
...
The table below summarizes the years and geographic levels for the data sources used. For information on how measures with data available at various geographic levels were processed, see the [Geography Methods](https://github.com/mitre/hse-mwi/blob/main/Documentation/Methods/Geography%20Methods.pdf) document. 
